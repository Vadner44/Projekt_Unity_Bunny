...
public class BunnyController : MonoBehaviour
{
    ...
    {
        bool groundCheck = Physics2D.Raycast(new Vector2(transform.position.x, transform.position.y - height), -Vector2.up, rayCastLengthCheck);
    ...
    void FixedUpdate()
    {
        ...
        if (IsWalltoLeftOrRight() && isJumping)
        {
